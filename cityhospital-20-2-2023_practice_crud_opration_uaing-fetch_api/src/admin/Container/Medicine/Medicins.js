...
import { addMedicin, deleteMedicines, getMedicines, isLoading, postMedicine, putMedicine } from '../../../redux/action/medicine.action';
...
function Medicins(props) {
    ...
    console.log(medicineData.error);
    ...
    return (
        <>
            ...
            {
                medicineData.isLoading ? <Loading /> :
                    medicineData.error === null ?
                        ...
                        < Error errorMsg ={medicineData.error}/>
            }
